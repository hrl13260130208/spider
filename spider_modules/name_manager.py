...
# redis_ = redis.Redis(host="10.3.1.106",port=6379,db=8,decode_responses=True)
redis_ = redis.Redis(host="10.3.1.99",port=6379,db=8,decode_responses=True)
...
if __name__ == '__main__':
    ...
    for key in redis_.keys("cnpiec_40*"):
        redis_.delete(key)
